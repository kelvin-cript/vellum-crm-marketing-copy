...
export const FileUpload: React.FC<FileUploadProps> = ({ 
  ...
  if (hasData) {
    // Versão compacta futurística para quando já há dados
    return (
      <div className="space-y-4">
        ...
        >
          ...
          />
          <label htmlFor="file-upload-compact" className="cursor-pointer relative z-10">
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-xs text-emerald-400">
                Você pode carregar várias planilhas CSV. Os dados serão combinados automaticamente para análise completa.
              </p>
            </div>
          </div>
        </div>
  ...
  // Versão compacta para quando não há dados
  return (
      ...
      >
        ...
        <label htmlFor="file-upload" className="cursor-pointer">
          ...
          <p className="text-sm text-gray-300">
            Formatos aceitos: CSV • Suporte a múltiplas planilhas
          </p>
        </label>
      </div>
      ...
      <div className="p-4 bg-blue-500/10 rounded-xl border border-blue-500/20 backdrop-blur-sm relative z-10">
        <div className="flex items-start">
          ...
          <div className="text-sm text-blue-300">
            <p className="font-medium mb-2 text-base">Estrutura da planilha esperada:</p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs leading-relaxed text-gray-400">
              ...
              <div className="space-y-1">
                <p><strong className="text-purple-400">Status:</strong> Faturado/Cancelado</p>
